...
function App() {
  return (
    ...
    <Header text1="Manual de Problemas" text2="Comunes" text3="Perifericos" />
        ...
        {/* Cuadro gris, imagen y cuadro gris */}
        <article id='Objetivo del manual' className="grid lg:grid-cols-3 items-center px-8 md:px-20 lg:px-0 w-11/12 8 mb-10 gap-3 md:gap-0 justify-center">
          <div className='bg-neutral-100 relative p-6 md:p-10 shadow-xl shadow-indigo-200 rounded-2xl'>
            <h2 className="text-2xl md:text-3xl font-bold mb-5">Objetivo del manual</h2>
          ...
          <div className="flex items-center justify-center">
            <img src={Callie_call_center} className="w-6/12 md:w-4/12 lg:w-8/12" />
          </div>
          <div className='bg-neutral-100 relative p-6 md:p-10 shadow-xl shadow-indigo-200 rounded-2xl'>
            <h2 className="text-2xl md:text-3xl font-bold mb-5">Introducción</h2>
            <p className="md:leading-relaxed">
        ...
        <h1 className='font-bold leading-normal md:text-left text-center mt-10 text-3xl md:text-5xl text-[#0367a6]'>Objetivos <span className="text-white bg-[#0367a6] p-2 px-4 rounded-4xl">Generales</span></h1>
        {/* Primeros 3 objetivos */}
        <div className='grid md:grid-cols-3 md:mx-10 mt-7'>
        ...
        {/* Proximos 2 objetivos */}
        <div className='grid md:grid-cols-2 md:mx-10 mt-7 '>
          <div className="p-10 rounded-xl text-center flex flex-col items-center gap-4">
            <img src={app_3} className="w-32 h-auto text-[#047b9b]" />
            <h1 className='font-bold text-2xl'>Mejorar la primera llamada en la resolucion (FCR)</h1>
          ...
          <div className="p-10 rounded-xl text-center flex flex-col items-center gap-4">
            ...
            <h1 className='font-bold text-2xl'>Fortalecer las habilidades del agente</h1>
