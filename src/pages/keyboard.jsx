            ...
            <div className="container mx-auto px-4 py-8"> 
                    ...
                    <div className="flex flex-col lg:flex-col items-center gap-10 mb-16 p-8 bg-white rounded-3xl shadow-xl border border-blue-100">
                        <div className="flex-1 flex flex-col gap-6 items-start">
                            <div className="flex items-center gap-4 text-[#0096c8]">
                                ...
                                <h3 className="text-3xl font-bold">Cambiar el Idioma del Teclado</h3>
                            </div>
                    ...
                    <div className="flex flex-col lg:flex-col items-center gap-10 mb-16 p-8 bg-white rounded-3xl shadow-xl border border-blue-100">
                        <div className="flex flex-col gap-6 items-start">
                            <div className="flex items-center gap-4 text-[#0487d9]">
                                ...
                                <h3 className="text-3xl font-bold">Prueba de Funcionamiento</h3> 
                            </div>
                            <p><span className='text-xl font-bold'>Probar en otro dispositivo:</span> Conecta el teclado a otro ordenador para descartar un problema del hardware del teclado.</p>
                ...
                <div className='px-10'>
                    <div className="flex flex-col lg:flex-row items-center mb-16 p-8 bg-white rounded-3xl shadow-xl border border-blue-100">
                        <div className="flex flex-col gap-6 items-start w-6/12">
                            <div className="flex items-center gap-4 text-[#0487d9]">
                               <BsKeyboard className="bg-blue-100 p-3 w-14 h-auto rounded-full shadow-md " />
                               <h3 className="text-3xl font-bold">Teclas no responden</h3> 
                            </div>
                            <div className='flex flex-col gap-5 px-10'>
                                <p><span className='text-xl font-bold'>Verificar conexiones:</span> Asegúrate de que el teclado esté correctamente conectado al puerto USB, Verifica que las luces del teclado estén encendidas.</p>
                                <p><span className='text-xl font-bold'>Probar en otro puerto:</span> Conecta el teclado a otro puerto USB.</p>
                                <p><span className='text-xl font-bold'>Reiniciar el ordenador:</span> A veces, un reinicio puede solucionar problemas temporales</p>
                            </div>
                        </div>
